...
@Transactional
public class TrainTestControllerTest2 {
    private final Logger logger = LoggerFactory.getLogger(TrainTestControllerTest2.class);
    ...
    private  String mobile="13405947470";
