...
import com.dkd.common.model_custom.SentenceResolveTrainingCustom;

import java.util.ArrayList;
import java.util.Date;

public class XydSentenceResolveTraining {
    private Integer id;
    ...
    //冗余字段
    private ArrayList<SentenceResolveTrainingCustom> list;
    ...
    public ArrayList<SentenceResolveTrainingCustom> getList() {
        return list;
    }

    public void setList(ArrayList<SentenceResolveTrainingCustom> list) {
        this.list = list;
    }
