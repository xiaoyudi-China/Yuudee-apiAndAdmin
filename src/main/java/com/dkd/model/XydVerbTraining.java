...
import com.dkd.common.model_custom.VerbTrainingCustom;

import java.util.ArrayList;
import java.util.Date;

public class XydVerbTraining {
    private Integer id;
    ...
    private ArrayList<VerbTrainingCustom> list;

    public ArrayList<VerbTrainingCustom> getList() {
        return list;
    }

    public void setList(ArrayList<VerbTrainingCustom> list) {
        this.list = list;
    }
