...
import com.dkd.common.model_custom.SentenceGroupTestCustom;

import java.util.ArrayList;
import java.util.Date;

public class XydSentenceGroupTest {
    private Integer id;
    ...
    private ArrayList<SentenceGroupTestCustom> list;

    public ArrayList<SentenceGroupTestCustom> getList() {
        return list;
    }

    public void setList(ArrayList<SentenceGroupTestCustom> list) {
        this.list = list;
    }
