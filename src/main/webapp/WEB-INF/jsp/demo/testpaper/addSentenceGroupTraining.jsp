    ...
    <div id="page-wrapper" class="gray-bg">
        <div class="wrapper wrapper-content animated fadeInRight">
            <form class="form-horizontal" id="carouselFigure_form">
                <input type="hidden" name="id" id="id" value="${sentenceGroupTraining.id}">
                <legend>句子成组管理>>添加/编辑句子成组训练
                ...
                <div class="form-group" id="imgDiv">
                    ...
                    <div class="col-sm-3">
                        <div>
                            <div class="sc">
                                <img class="img-result img" id="img" src="${sentenceGroupTraining.cardOneImage}" width="160px" height="165px"/>
                                <%--<input name="cardColorImage" id="cardColorImage" hidden>--%>
                            </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="卡一文字" value="${sentenceGroupTraining.cardOneChar}" name="cardOneChar" class="form-control" id="cardOneChar" style="width:300px;">
                    </div>
                </div>
                <div class="form-group"  >
                    ...
                    <div class="col-sm-3">
                        <div>
                            <c:if test="${sentenceGroupTraining != null && sentenceGroupTraining.cardOneRecord != null && sentenceGroupTraining.cardOneRecord != ''}">
                                <audio id="audio" src="${sentenceGroupTraining.cardOneRecord} " controls ></audio><br/>
                            </c:if>
                ...
                <div class="form-group" id="imgDiv2">
                    ...
                    <div class="col-sm-3">
                        <div>
                            <div class="sc">
                                <img class="img-result img" src="${sentenceGroupTraining.cardTwoImage}"  id="img2" width="160px" height="165px"/>
                            </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="卡二名词" value="${sentenceGroupTraining.cardTwoChar}" name="cardTwoChar" class="form-control" id="cardTwoChar" style="width:300px;">
                    </div>
                </div>
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-sm-3">
                        <div>
                            <c:if test="${sentenceGroupTraining != null && sentenceGroupTraining.cardTwoRecord != null && sentenceGroupTraining.cardTwoRecord != ''}">
                                <audio id="audio" src="${sentenceGroupTraining.cardTwoRecord} " controls ></audio><br/>
                            </c:if>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="组合文字" value="${sentenceGroupTraining.groupChar}" name="groupChar" class="form-control" id="groupChar" style="width:300px;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div>
                            <c:if test="${sentenceGroupTraining != null && sentenceGroupTraining.groupRecord != null && sentenceGroupTraining.groupRecord != ''}">
                                <audio id="audio" src="${sentenceGroupTraining.groupRecord} " controls ></audio><br/>
                            </c:if>
...
<script>
    $(document).ready(function () {
        ...
        $("#btn-ok").click(function(){
            ...
            var url = ""
            if (id == null || id=="") {
                url = "${path}/manage/sentence/addSentenceGroupTraining"
            } else {
                url = "${path}/manage/sentence/updateSentenceGroupTraining"
            }
            $.ajax({
                url:url,
                type: 'POST',
                ...
                success: function (response) {
                    if(response.code == "200"){
                        alert("添加成功！")
                        window.location.href = "${path}/manage/sentence/toSentenceGroupTrainingPage";
                    }else{
                        alert(response.msg)
                    }
                },
