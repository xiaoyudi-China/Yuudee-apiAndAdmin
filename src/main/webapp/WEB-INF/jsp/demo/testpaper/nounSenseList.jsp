        ...
        <div class="container-fluid">
            <div class="row" style="margin-left: 10px;margin-top: 20px;">
                ...
                <div style="line-height: 34px;display: inline-block;">
                    <label>干扰分类</label>
                    <div style="width: 200px;display: inline-block;margin: 0px 20px 0px 10px;">
                        <select id="disturbType" class="form-control">
                            <option value="">请选择干扰类型</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 input-group">
                            <select id="states" class="form-control">
                                ...
                                <%--<c:forEach items="${60}" var="0"  varStatus="status">
...
//                + '<button class="sendEmail btn btn-success" style="margin-left: 10px">发送邮件</button></div>',
            ...
            columns: [
                ...
                },
                {
                    ...
                    "title": "卡1颜色图",
                    "type": "html",
                    "data": "cardAdjectiveImage",
                    "defaultContent": "",
                    "name": "cardAdjectiveImage",
                    ...
                    "title": "卡1形容词",
                    "type": "html",
                    "data": "cardAdjectiveChar",
                    "defaultContent": "",
                    "name": "cardAdjectiveChar"
                },
                {
                    "title": "卡1形容词录音",
                    "type": "html",
            ...
            serverSide: true,
            ajax: {
                "url": "${path}/manage/noun/getNounSenseList",
                "data": function (d) {
                    d.groupChar = groupChar;
                    d.disturbType = disturbType;
                }
            },
        ...
        $(".bt-add").click(function () {
            window.location.href = "${path}/manage/noun/toAddNounSensePage";
        });
        //编辑
        $dataTable.on('click', ".btn-edit", function () {
            var id = $(this).attr("id");
            window.location.href = "${path}/manage/noun/toAddNounSensePage?id=" + id;
        });
        ...
        $dataTable.on('click', ".btn-delete", function () {
            ...
            $.ajax({
                url: "${path}/manage/noun/deleteNounSense",
                dataType: 'JSON',
                type: 'POST',
                data: {
                    id: id,
