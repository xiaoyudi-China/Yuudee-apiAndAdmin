...
//                + '<button class="sendEmail btn btn-success" style="margin-left: 10px">发送邮件</button></div>',
            ...
            serverSide: true,
            ajax: {
                "url": "${path}/manage/sentence/getSentencegroupTestList",
                "data": function (d) {
        ...
        $(".bt-add").click(function(){
            window.location.href = "${path}/manage/sentence/toAddSentenceGroupTest";
        });
        ...
        $dataTable.on('click', ".btn-edit", function () {
            var id = $(this).attr("id");
            window.location.href = "${path}/manage/sentence/toAddSentenceGroupTest?id=" + id;
        });
        //删除
        $dataTable.on('click',".btn-delete",function () {
            ...
            $.ajax({
                url:"${path}/manage/sentence/deleteSentencegroupTest",
                dataType:'JSON',
                type: 'POST',
                data:{
                    id:id,
