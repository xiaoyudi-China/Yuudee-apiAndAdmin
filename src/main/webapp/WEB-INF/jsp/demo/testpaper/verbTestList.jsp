...
//                + '<button class="sendEmail btn btn-success" style="margin-left: 10px">发送邮件</button></div>',
            ...
            serverSide: true,
            ajax: {
                "url": "${path}/manage/verb/getVerbTestList",
                "data": function (d) {
        ...
        $(".bt-add").click(function () {
            window.location.href = "${path}/manage/verb/toAddVerbTest";
        });
        $dataTable.on('click', ".btn-edit", function () {
            var id = $(this).attr("id");
            window.location.href = "${path}/manage/verb/toAddVerbTest?id=" + id;
        });
        ...
        $dataTable.on('click', ".btn-delete", function () {
            ...
            $.ajax({
                url: "${path}/manage/verb/deleteVerbTest",
                dataType: 'JSON',
                type: 'POST',
                data: {
                    id: id,
