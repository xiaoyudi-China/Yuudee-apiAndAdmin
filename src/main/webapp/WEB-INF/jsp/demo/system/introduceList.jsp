...
//                + '<button class="sendEmail btn btn-success" style="margin-left: 10px">发送邮件</button></div>',
            ...
            serverSide: true,
            ajax: {
                "url": "${path}/manage/system/getIntroduceList.ajax",
                "data": function (d) {
                    d.type;
                }
            },
        ...
        $("#bt-add").click(function(){
            window.location.href = "${path}/manage/system/toIntroduceInfo";
        });

        //修改
        $dataTable.on('click',".btn-edit",function () {
            id= $(this).attr("id");
            window.location.href = "${path}/manage/system/toIntroduceInfo?id="+id;
        });
        //删除
        $dataTable.on('click',".btn-delete",function () {
            id= $(this).attr("id");
            $.ajax({
                url:"${path}/manage/system/Introducedelete",
                dataType:'JSON',
                data:{
                    id:id,
                },
